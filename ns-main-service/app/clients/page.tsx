'use client';
import { Container, Grid, Card, Text, Title, GridCol, ActionIcon, Button, Pagination } from '@mantine/core';
...
const ClientsPage = () => {
  ...
  const fetchClients = async () => {
    ...
    try {
      ...
      const response = await fetch(`/api/clients?offset=${offset}&limit=${limit}`);
