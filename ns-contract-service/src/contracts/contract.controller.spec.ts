...
describe("ContractController", () => {
  ...
  describe("POST /contracts", () => {
    it("success - should create a new contract", async () => {
      ...
      jest.spyOn(contractService, "create").mockResolvedValue(createdContract);
  ...
  describe("PUT /contracts/:id", () => {
    it("success - should update a contract", async () => {
      ...
      jest.spyOn(contractService, "update").mockResolvedValue(updatedContract);
